    ...
    <header className="bg-black shadow-sm sticky top-0 z-50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-3">
              <Button
                variant="ghost"
                size="sm"
                className="p-2 hover:bg-gray-800 text-gray-300"
                onClick={() => window.open("https://www.tiktok.com/@kama.pure.culinar", "_blank")}
              >
                <TikTokIcon />
              ...
              <Button
                ...
                size="sm"
                className="p-2 hover:bg-gray-800 text-gray-300"
                onClick={() => window.open("https://www.instagram.com/kama_gastronomy/", "_blank")}
              >
                <InstagramIcon />
            ...
            <div className="flex items-center text-gray-300">
              ...
              <span className="text-sm font-medium">(+30) 69 76790121</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          {/* Contact Us Button & Mobile Menu - Far Right */}
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Button
              className="bg-red-600 hover:bg-red-700 text-white px-4 sm:px-6 py-2 rounded-full text-sm sm:text-base"
              ...
              <div className="p-6 border-t border-gray-700">
                <div className="flex justify-center space-x-4 mb-4">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="p-3 hover:bg-gray-800 text-gray-300"
                    onClick={() => window.open("https://www.tiktok.com/@kama.pure.culinar", "_blank")}
                  >
                    <TikTokIcon />
                    <span className="sr-only">TikTok</span>
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-400">(+30) 69 76790121</p>
                </div>
              </div>
            </div>
          </div>
